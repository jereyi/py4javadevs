...
describe("Lesson Page", () => { 
    ...
    test("renders exercise page correctly", async () => {
        ...
        const description = await screen.findByText(/desc1/i);
        const topicCell = screen.getByRole('cell', {
            name: VARIABLES_LESSON_RESPONSE[0].topic
          });
        const javaCell = screen.getByRole('cell', {
            name: VARIABLES_LESSON_RESPONSE[0].java
          });
        const pythonCell = screen.getByRole('cell', {
    ...
    test("lesson marked as incomplete when 'mark lesson as incomplete' button clicked", async ()=>{
        ...
        const getUserResponse = {
            ...
            last_login: new Date("07/27/2023"),
            completed_lessons: []
        };
